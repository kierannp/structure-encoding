...
from optimizer import OptimizerAE, OptimizerVAE, OptimizerOur
from optimizer import OptimizerVAE as Optimizer_graphite
from input_data import load_data, generate_data, load_mol_data
from model import GCNModelVAE, OurModelVAE
from preprocessing import preprocess_graph,preprocess_graph_e,construct_feed_dict, sparse_to_tuple, mask_test_edges
from preprocessing import mask_test_graphs, graph_padding,preprocess_graph_generate, preprocess_graph_generate_e
...
graph_list, graph_size = load_mol_data()
...
saver.save(sess, '../saved_models/'+str(datetime.now()),global_step=1000)